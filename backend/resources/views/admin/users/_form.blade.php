@php
    // Use plain defaults — @props breaks when this partial is @include'd (it resets mode/user).
    $mode = $mode ?? 'create';
    $user = $user ?? null;
    ...
    $closeModal = $isEdit ? 'user-edit-modal' : 'user-create-modal';
@endphp
...
>
    ...
    <div class="admin-modal-footer">
        <button type="button" class="btn-brand-outline" x-on:click="$dispatch('close-modal', '{{ $closeModal }}')">Cancel</button>
