...
class ImportEnvSettingsCommand extends Command
{
    ...
    private array $map = [
        ...
        'KAJABI_SITE_ID' => 'kajabi_site_id',
        'KAJABI_OFFER_ID' => 'kajabi_offer_id',
        'KAJABI_OFFER_TITLE' => 'kajabi_offer_title',
        'KAJABI_ENABLED' => 'kajabi_enabled',
        ...
        'OFFICE_AUTO_REPLY_ENABLED' => 'office_auto_reply_enabled',
        'OFFICE_AUTO_REPLY_HOURS' => 'office_auto_reply_hours',
        'OFFICE_IMAP_HOST' => 'office_imap_host',
        'OFFICE_IMAP_PORT' => 'office_imap_port',
        'OFFICE_IMAP_ENCRYPTION' => 'office_imap_encryption',
        'OFFICE_IMAP_USERNAME' => 'office_imap_username',
        'OFFICE_IMAP_PASSWORD' => 'office_imap_password',
        'OFFICE_IMAP_INBOX_FOLDER' => 'office_imap_inbox_folder',
        'OFFICE_IMAP_SENT_FOLDER' => 'office_imap_sent_folder',
